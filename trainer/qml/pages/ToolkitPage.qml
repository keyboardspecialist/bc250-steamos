...
ColumnLayout {
    ...
    ListModel {
        ...
        ListElement { componentId: "mesh"; categoryName: "PERFORMANCE"; title: "MESA / RADV PATCH"; description: "Optional global driver after AMDGPU fixes are active."; primary: "mesh-setup"; repair: ""; remove: "mesh-remove" }
