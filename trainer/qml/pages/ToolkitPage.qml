...
ColumnLayout {
    ...
    ListModel {
        ...
        ListElement { componentId: "fan"; categoryName: "DEVICES"; title: "NCT6687 FAN DRIVER"; description: "Pinned hwmon tachometer and PWM support for compatible Nuvoton controllers."; primary: "fan-install"; repair: ""; secondaryText: "REPAIR"; remove: "fan-remove" }
