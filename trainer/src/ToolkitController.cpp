...
constexpr OperationDefinition Operations[] = {
    ...
    {"compute-build", "Build GPU CU unlock tools", "compute", "BUILD",
     "Install dependencies and build UMR for GPU CU/WGP routing.", false, false},
    ...
    {"audio-build", "Build AMDGPU kernel fixes", "audio", "BUILD + INSTALL",
     "Install the display/audio clock, telemetry, and GFX1013 compute-queue fixes. Reboot before installing Mesa / RADV.", false, false},
    ...
    {"mesh-setup", "Build Mesa / RADV performance patch", "mesh", "BUILD + INSTALL",
     "Build the optional, recommended global driver after the AMDGPU fixes are active; this can take 20-40 minutes.", false, false},
    {"mesh-remove", "Remove Mesa / RADV performance patch", "mesh", "REMOVE",
