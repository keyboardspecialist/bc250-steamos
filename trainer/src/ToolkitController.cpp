...
constexpr OperationDefinition Operations[] = {
    ...
    {"power-install", "Install power management", "power", "INSTALL",
     "Build and install ACPI support, the governor, helpers, and persistence.", false, false},
    {"power-remove", "Remove power management", "power", "REMOVE",
     "Disable and remove toolkit power services and overrides.", false, true},
    ...
    {"compute-build", "Build compute prerequisites", "compute", "BUILD",
     "Install dependencies and build UMR for compute-unit management.", false, false},
    {"compute-remove", "Remove compute integration", "compute", "REMOVE",
     "Restore stock routing where possible and remove compute replay integration.", false, true},
    ...
    {"audio-build", "Build patched AMDGPU", "audio", "BUILD + INSTALL",
     "Build and install the display-clock and metrics driver fixes.", false, false},
    {"audio-remove", "Remove patched AMDGPU", "audio", "REMOVE",
     "Restore stock AMDGPU module overrides and preserve build caches.", false, true},
    {"mesh-setup", "Build mesh-shader RADV", "mesh", "BUILD + INSTALL",
     "Build the pinned alternate RADV driver; this can take 20-40 minutes.", false, false},
    {"mesh-remove", "Remove mesh-shader RADV", "mesh", "REMOVE",
     "Remove the alternate runtime and managed game entries while preserving caches.", false, true},
