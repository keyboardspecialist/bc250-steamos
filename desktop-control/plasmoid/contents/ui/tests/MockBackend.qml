...
QtObject {
    ...
    property var snapshot: ({
        ...
        gpu: {
            ...
            requestedMode: "adaptive", requestedMinimum: 350, requestedMaximum: 1500,
            minimum: 350, maximum: 1500, liveMinimum: 350, liveMaximum: 1500,
            initialMinimum: 350, initialMaximum: 1500, activeMhz: 1120,
            levels: ["350", "500", "1000", "1500"], allowedMinimum: 350, allowedMaximum: 2230,
            climbMs: 500, governorService: { enabled: "enabled", active: "active" },
            frequencyRestore: { enabled: "enabled", active: "exited" }, persistent: true,
            replayApplied: true, safePoints: [{ frequency: 350, voltage: 700 }, { frequency: 1500, voltage: 975 }],
