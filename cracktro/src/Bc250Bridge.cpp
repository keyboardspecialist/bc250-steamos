...
void Bc250Bridge::setGpuFrequency(const QString &mode, int minimum, int maximum)
{
    ...
    if (mode == QStringLiteral("pin") && (maximum < 100 || maximum > 2150)) {
        reject(QStringLiteral("Pinned frequency must be 100-2150 MHz.")); return;
    }
    if (mode == QStringLiteral("range") && (minimum < 0 || minimum > 2150 || maximum < 100
