...
class DriverLifecycleTests(unittest.TestCase):
    ...
    def test_amdgpu_build_integrates_cyan_skillfish_metrics_patches(self):
        ...
        self.assertIn("CYAN_SKILLFISH_ROBIN3_SET_TOOLS_HIGH", core_metrics_patch)
        self.assertIn("CYAN_SKILLFISH_ROBIN3_SET_TOOLS_LOW", core_metrics_patch)
        self.assertIn("0x3e", core_metrics_patch)
        self.assertIn("0x3f", core_metrics_patch)
        ...
        self.assertIn("memset(table->cpu_addr, 0xff", core_metrics_patch)
        self.assertIn("amdgpu_asic_flush_hdp", core_metrics_patch)
        self.assertIn("amdgpu_asic_invalidate_hdp", core_metrics_patch)
        self.assertIn("ret = -EAGAIN", core_metrics_patch)
        ...
        self.assertIn("OLD_Q3_DRIVER_SOURCE_SHA", builder)
        self.assertIn("core_metrics_applied", builder)
