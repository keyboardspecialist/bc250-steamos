...
export const installNativeMesh = callable<[], void>("install_native_mesh");
export const uninstallNativeMesh = callable<[], void>("uninstall_native_mesh");
...
export const installOptiscaler = callable<
  [candidateId: string, proxy: string],
  void
>("install_optiscaler");
export const uninstallOptiscaler = callable<[candidateId: string], void>(
